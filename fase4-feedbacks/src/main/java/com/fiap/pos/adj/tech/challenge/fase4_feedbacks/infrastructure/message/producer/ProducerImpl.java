...
import com.fiap.pos.adj.tech.challenge.fase4_feedbacks.application.configs.message.PropertiesConfig;
...
public final class ProducerImpl implements Producer {
    ...
    @Override
    public void sendEventCreateFeedbacks(MessageFeedback kafka) {
